...
<body>
    ...
    <div class="row p-0 m-0 d-flex flex-row justify-content-center align-items-center" style="border-top:2px dashed #1f4a4d;">
        <div class="col-md-1 p-0 m-0 pt-2">
            <img src="<?php echo url_for('/images/logo11.png'); ?>" id="img1" width="82%" style="float:right;">
            <div class="row  " id="for_mobile" style="display: none;">
                <div class="col-12 w-100 d-flex flex-row justify-content-between">
                    <img src="<?php echo url_for('/images/logo11.png'); ?>" id="img1" width="40%" style="">
                    <img src="<?php echo url_for('/images/logo%20(1).png'); ?>" id="img2" width="40%">
        ...
        <div class="col-md-7 d-flex flex-row justify-content-center ">
            <img src="<?php echo url_for('/images/logo%20(2).png'); ?>" width="100%" height="80%" id="img3">
        </div>

        <div class="col-md-3 d-flex flex-column justify-content-center p-0 m-0">
            ...
            <div class="row d-flex flex-row justify-content-center w-100">
                <div class=" search_div m-1" style="position: relative;border-radius: 12px;width: 75%;border: 2px solid #1f4a4d">
                    <input id="search_input" type="text" placeholder="Search.." style="width: 100%;height: 30px; padding-left:  5px;border-radius: 12px;"><i class="fa fa-search" aria-hidden="true" style="position: absolute;top: 5px;right: 0px;width: 30px;height: 30px;cursor: pointer;"></i>
                </div>
            </div>

        </div>

        <div class="col-md-1 p-0 m-0 pt-2 aktu_pic">
