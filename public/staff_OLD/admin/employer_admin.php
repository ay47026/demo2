...
<body>
    ...
    <div class="jumbotron p-0 m-0" style="width: 100% ;height:100vh;">
        ...
        <ul class="nav nav-tabs pl-4" id="myTab" role="tablist" style="10vh">
                            <span class="employe_ad_span">EMPLOYE ADMIN :</span>
       <li class="nav-item">
           <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Add new employe</a>
       </li>
       <li class="nav-item">
           <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">All employe</a>
       </li>
       <li class="nav-item">
           <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">Search employe</a>
       </li>
   </ul>
   <div class="tab-content p-1" id="myTabContent" style=" height: 80vh; width: 99%;margin-top: 5px;">
       <div class="tab-pane  show active" id="home" role="tabpanel" aria-labelledby="home-tab">
        ...
        <!-- FORM --START -->
        <?php include('./shared/employer_admin_form.php'); ?>
        <!-- FORM -----------------------ENDS -->

      </div>
      <!-- For All employee [tab]  -->
       <div class="tab-pane " id="profile" role="tabpanel" aria-labelledby="profile-tab">   --DETAILS OF ALL EMPLOYEES--         </div>
...
<!-- JAVASCRIPT----------------------  -->
    <script>
        ...
        function get_all_employees() {
            ...
            xhr.open("GET", "./process/get_all_employees.php", true);
